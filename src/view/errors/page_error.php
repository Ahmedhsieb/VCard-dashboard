...
<div class="container-xxl container-p-y">
    <div class="misc-wrapper">
        ...
        <a href="<?=$_SERVER['REQUEST_SCHEME'] . '://'.host_path()?>" class="btn btn-primary">Back to home</a>
        <div class="mt-3">
            <img src="<?= assets("admin/img/illustrations/page-misc-error-light.png")?>" alt="page-misc-error-light" width="500" class="img-fluid" data-app-dark-img="illustrations/page-misc-error-dark.png" data-app-light-img="illustrations/page-misc-error-light.png">
        </div>
    </div>
</div>
<!-- /Error -->
