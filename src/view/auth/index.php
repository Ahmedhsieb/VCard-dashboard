            ...
            <div class="row mt-lg-n10 mt-md-n11 mt-n10">
                <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form role="form text-left" action="create" method="post" enctype="multipart/form-data">
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="Domain Name" name="domainname" aria-label="Name" aria-describedby="email-addon">
                                </div>
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="Name" name="username" aria-label="Name" aria-describedby="email-addon">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="Address" name="address" aria-label="Password" aria-describedby="password-addon">
                                </div>
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="Phone" name="phone" aria-label="Password" aria-describedby="password-addon">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <textarea type="text" class="form-control" placeholder="Brief" name="title" aria-label="Password" aria-describedby="password-addon"></textarea>
                                </div>
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="Job Title" name="job_title" aria-label="Password" aria-describedby="password-addon">
                                </div>
                                <div class="text-center">
                                    <input type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2" value="Sign up" style="background-image: linear-gradient(310deg, #bc8504 0%, #ea0606 100%)">
                                </div>
                            </form>
                        </div>
                    </div>
