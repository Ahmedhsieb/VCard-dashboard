...
<div class="container-xxl container-p-y">
    <div class="misc-wrapper">
        <h2 class="mb-2 mx-2"><?="Welcome ".$username?></h2>
        <p class="mb-4 mx-2">Your Vcard in successfully Created </p>
        <a href="http://<?=$domainname?>.vcard.vc" class="btn btn-primary">Go To Your Vcard</a>
        <div class="mt-4">
            <img src="<?= assets("admin/img/illustrations/man-with-laptop-light.png")?>" alt="girl-doing-yoga-light" width="500" class="img-fluid" data-app-dark-img="illustrations/girl-doing-yoga-dark.png" data-app-light-img="illustrations/girl-doing-yoga-light.png">
        </div>
    </div>
</div>
<!-- /Under Maintenance -->
